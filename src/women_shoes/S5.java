...
public class S5 extends S6{
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(S5.class.getResource("/Images/Women/Clothes/shoes/5_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(S5.class.getResource("/Images/Women/Clothes/shoes/5_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(S5.class.getResource("/Images/Women/Clothes/shoes/5_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Toe Ring Flat Slipper");
		...
		JLabel lblPomPomDetail = new JLabel("\u20B91200.00");
		lblPomPomDetail.setFont(new Font("Tahoma", Font.BOLD, 16));
		lblPomPomDetail.setBackground(Color.WHITE);
		lblPomPomDetail.setBounds(220, 406, 91, 20);
		frame.getContentPane().add(lblPomPomDetail);
		...
		button.setBounds(83, 441, 167, 29);
		panel_3.add(button);
		...
		label.setIcon(new ImageIcon(S5.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
