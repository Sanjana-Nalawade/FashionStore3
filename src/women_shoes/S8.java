...
public class S8 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(S8.class.getResource("/Images/Women/Clothes/shoes/8_1.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Knot Detail Linen Sliders        ");
		...
		JLabel label_14 = new JLabel("\u20B9393.00");
		...
		button.setBounds(80, 441, 167, 29);
		panel_3.add(button);
		...
		label_3.setIcon(new ImageIcon(S8.class.getResource("/Images/Women/Clothes/shoes/8_2.jpg")));
		label_3.setOpaque(true);
		label_3.setBackground(Color.LIGHT_GRAY);
		label_3.setBounds(288, 11, 242, 294);
		panel_3.add(label_3);
