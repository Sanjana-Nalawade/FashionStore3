...
public class S6 extends S7{
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(S6.class.getResource("/Images/Women/Clothes/shoes/6_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(S6.class.getResource("/Images/Women/Clothes/shoes/6_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(S6.class.getResource("/Images/Women/Clothes/shoes/6_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Pom Pom Detail Toe");
		...
		JLabel label_14 = new JLabel("\u20B9441.00");
		...
		button.setBounds(76, 430, 167, 29);
		panel_3.add(button);
		...
		label.setIcon(new ImageIcon(S6.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
