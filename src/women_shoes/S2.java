...
public class S2 extends S3{
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(S2.class.getResource("/Images/Women/Clothes/shoes/2_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(S2.class.getResource("/Images/Women/Clothes/shoes/2_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(S2.class.getResource("/Images/Women/Clothes/shoes/2_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Pointed Toe Net Flats ");
		...
		JLabel label_14 = new JLabel("\u20B91642.00");
		...
		button.setBounds(88, 443, 167, 29);
		panel_3.add(button);
		...
		label.setIcon(new ImageIcon(S2.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
