...
public class S4 extends S5{
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(S4.class.getResource("/Images/Women/Clothes/shoes/4_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(S4.class.getResource("/Images/Women/Clothes/shoes/4_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(S4.class.getResource("/Images/Women/Clothes/shoes/4_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Round Toe Lace Up PU Sneakers ");
		...
		JLabel label_14 = new JLabel("\u20B92256.00");
		...
		button.setBounds(81, 442, 167, 29);
		panel_3.add(button);
		...
		label.setIcon(new ImageIcon(S4.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
