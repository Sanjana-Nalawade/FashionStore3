...
public class S7 extends S8{
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(S7.class.getResource("/Images/Women/Clothes/shoes/7_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(S7.class.getResource("/Images/Women/Clothes/shoes/7_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(S7.class.getResource("/Images/Women/Clothes/shoes/7_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Toe Ring Flat Sandals  With Studded");
		...
		JLabel label_14 = new JLabel("\u20B91435.00");
		...
		button.setBounds(78, 440, 167, 29);
		panel_3.add(button);
		...
		label.setIcon(new ImageIcon(S7.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
