...
public class S3 extends S4{
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(S3.class.getResource("/Images/Women/Clothes/shoes/3_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(S3.class.getResource("/Images/Women/Clothes/shoes/3_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(S3.class.getResource("/Images/Women/Clothes/shoes/3_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("PU Cap Toe Flats");
		...
		JLabel label_14 = new JLabel("\u20B91932.00");
		...
		button.setBounds(83, 480, 167, 29);
		panel_3.add(button);
		...
		label.setIcon(new ImageIcon(S3.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
