...
public class boy2 {
	...
	static public void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon(boy2.class.getResource("/Images/kids/coverpage/2027539a.jpg")));
		...
		JLabel lblRs = new JLabel("Rs 499");
		...
		JLabel lblNewLabel_1 = new JLabel("Babyhug Full Sleeves Striped Sweater With Pant - Red ");
		lblNewLabel_1.setBounds(187, 434, 435, 20);
		frame.getContentPane().add(lblNewLabel_1);
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		
		JLabel label_3 = new JLabel("");
		label_3.setIcon(new ImageIcon(boy2.class.getResource("/Images/kids/thumbnails/boys/2027539b.jpg")));
		...
		JLabel lblTypeTee = new JLabel("Type - Sweater set");
		panel_2.add(lblTypeTee);
		
		JLabel lblNewLabel_7 = new JLabel("Neck - Round Neck");
		panel_2.add(lblNewLabel_7);
		
		JLabel lblNewLabel_6 = new JLabel("Sleeves - Full Sleeves");
		panel_2.add(lblNewLabel_6);
		
		JLabel lblNewLabel_3 = new JLabel(" Fit- Regular fit");
		panel_2.add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel(" Occation-  Winter wear");
		...
		label_2.setIcon(new ImageIcon(boy2.class.getResource("/Images/kids/thumbnails/boys/2027539c.jpg")));
		...
		label.setIcon(new ImageIcon(boy2.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
	}
}
