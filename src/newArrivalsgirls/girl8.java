...
public class girl8 {
	...
	static public void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon(girl8.class.getResource("/Images/2117004a - Copy.jpg")));
		...
		JLabel lblNewLabel_1 = new JLabel("Memory Life Rabbit  Print Top");
		lblNewLabel_1.setBounds(187, 434, 435, 20);
		frame.getContentPane().add(lblNewLabel_1);
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		
		JLabel label_3 = new JLabel("");
		label_3.setIcon(new ImageIcon(girl8.class.getResource("/Images/kids/thumbnails/2117004b.jpg")));
		label_3.setBounds(566, 167, 134, 172);
		...
		label.setIcon(new ImageIcon(girl8.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
	}
}
