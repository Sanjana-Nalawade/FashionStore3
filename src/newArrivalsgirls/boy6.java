...
public class boy6 {
	...
	static public void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon(boy6.class.getResource("/Images/kids/coverpage/2228039a.jpg")));
		...
		JLabel lblRs = new JLabel("Rs 400");
		...
		JLabel lblNewLabel_1 = new JLabel("Olio Kids Full Sleeves Tee & Lounge Pant Animal Print ");
		lblNewLabel_1.setBounds(187, 434, 435, 20);
		frame.getContentPane().add(lblNewLabel_1);
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		
		JLabel label_3 = new JLabel("");
		label_3.setIcon(new ImageIcon(boy6.class.getResource("/Images/kids/thumbnails/boys/2228039b.jpg")));
		...
		JLabel lblBrandawadox = new JLabel("Brand - Olio Kids");
		lblBrandawadox.setFont(new Font("Tahoma", Font.PLAIN, 11));
		panel_2.add(lblBrandawadox);
		
		JLabel lblTypeTee = new JLabel("Type - Tee &Lounge Pant");
		...
		label_2.setIcon(new ImageIcon(boy6.class.getResource("/Images/kids/thumbnails/boys/2228039d.jpg")));
		...
		label.setIcon(new ImageIcon(boy6.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
	}
}
