...
public class girl4 {
	...
	static public void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon(girl4.class.getResource("/Images/2117049a.jpg")));
		...
		JLabel lblRs = new JLabel("Rs 328");
		...
		JLabel lblNewLabel_1 = new JLabel("Memory Life Love Wins Print Sequined Top");
		lblNewLabel_1.setBounds(187, 434, 435, 20);
		frame.getContentPane().add(lblNewLabel_1);
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		
		JLabel label_3 = new JLabel("");
		label_3.setIcon(new ImageIcon(girl4.class.getResource("/Images/kids/thumbnails/2117049b.jpg")));
		...
		label_2.setIcon(new ImageIcon(girl4.class.getResource("/Images/kids/thumbnails/2117049c.jpg")));
		...
		label.setIcon(new ImageIcon(girl4.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
	}
}
