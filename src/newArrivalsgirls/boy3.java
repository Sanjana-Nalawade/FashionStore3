...
public class boy3 {
	...
	static public void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon(boy3.class.getResource("/Images/kids/coverpage/2049289a.jpg")));
		...
		JLabel lblNewLabel_1 = new JLabel("Babyoye Dungaree Style Denim Romper ");
		lblNewLabel_1.setBounds(187, 434, 435, 20);
		frame.getContentPane().add(lblNewLabel_1);
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		
		JLabel label_3 = new JLabel("");
		label_3.setIcon(new ImageIcon(boy3.class.getResource("/Images/kids/thumbnails/boys/2049289b.jpg")));
		...
		JLabel lblBrandawadox = new JLabel("Brand-Babyoye");
		lblBrandawadox.setFont(new Font("Tahoma", Font.PLAIN, 11));
		panel_2.add(lblBrandawadox);
		
		JLabel lblTypeTee = new JLabel("Type : Dungaree");
		panel_2.add(lblTypeTee);
		
		JLabel lblNewLabel_7 = new JLabel("Neck - Square Neck");
		...
		label_2.setIcon(new ImageIcon(boy3.class.getResource("/Images/kids/thumbnails/boys/2049289d.jpg")));
		...
		label.setIcon(new ImageIcon(boy3.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
	}
}
