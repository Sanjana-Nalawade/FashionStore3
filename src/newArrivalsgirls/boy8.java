...
public class boy8 {
	...
	static public void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon(boy8.class.getResource("/Images/kids/coverpage/2276918a.jpg")));
		...
		JLabel lblRs = new JLabel("Rs 850");
		...
		JLabel lblNewLabel_1 = new JLabel("BownBee Embroidered Jacket With Dhoti Set");
		lblNewLabel_1.setBounds(187, 434, 435, 20);
		frame.getContentPane().add(lblNewLabel_1);
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		
		JLabel label_3 = new JLabel("");
		label_3.setIcon(new ImageIcon(boy8.class.getResource("/Images/kids/thumbnails/boys/2276918d.jpg")));
		...
		JLabel lblBrandawadox = new JLabel("Brand-Kid1");
		lblBrandawadox.setFont(new Font("Tahoma", Font.PLAIN, 11));
		panel_2.add(lblBrandawadox);
		
		JLabel lblTypeTee = new JLabel("Type : Kedia Set");
		panel_2.add(lblTypeTee);
		
		JLabel lblNewLabel_7 = new JLabel("Neck - V Neck");
		panel_2.add(lblNewLabel_7);
		
		JLabel lblNewLabel_6 = new JLabel(" Sleeves-Full");
		panel_2.add(lblNewLabel_6);
		
		JLabel lblNewLabel_3 = new JLabel(" Fit- Regular fit");
		panel_2.add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel(" Occation- Ethnic wear");
		...
		label_2.setIcon(new ImageIcon(boy8.class.getResource("/Images/kids/thumbnails/boys/2276918i.jpg")));
		...
		label.setIcon(new ImageIcon(boy8.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
	}
}
