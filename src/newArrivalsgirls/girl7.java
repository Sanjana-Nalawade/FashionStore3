...
public class girl7 {
	...
	static public void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon(girl7.class.getResource("/Images/2005198a.jpg")));
		...
		JLabel lblRs = new JLabel("Rs 639");
		...
		JLabel lblNewLabel_1 = new JLabel("Lilpicks Couture Printed Short Jumpsuit - White ");
		lblNewLabel_1.setBounds(187, 434, 435, 20);
		frame.getContentPane().add(lblNewLabel_1);
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		
		JLabel label_3 = new JLabel("");
		label_3.setIcon(new ImageIcon(girl7.class.getResource("/Images/kids/thumbnails/2005198b.jpg")));
		...
		JLabel lblBrandawadox = new JLabel("Brand Name - Lilpicks ");
		lblBrandawadox.setFont(new Font("Tahoma", Font.PLAIN, 11));
		panel_2.add(lblBrandawadox);
		
		JLabel lblTypeTee = new JLabel("Type : Jumpsuit");
		panel_2.add(lblTypeTee);
		
		JLabel lblNewLabel_7 = new JLabel("Neck - Singlet Neck");
		...
		label_2.setIcon(new ImageIcon(girl7.class.getResource("/Images/kids/thumbnails/2005198c.jpg")));
		...
		label.setIcon(new ImageIcon(girl7.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
	}
}
