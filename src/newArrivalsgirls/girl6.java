...
public class girl6 {
	...
	static public void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon(girl6.class.getResource("/Images/2149740a - Copy.jpg")));
		...
		JLabel lblRs = new JLabel("Rs 490");
		...
		JLabel lblNewLabel_1 = new JLabel("B&G Kids Flower Applique Dress");
		lblNewLabel_1.setBounds(187, 434, 435, 20);
		frame.getContentPane().add(lblNewLabel_1);
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		
		JLabel label_3 = new JLabel("");
		label_3.setIcon(new ImageIcon(girl6.class.getResource("/Images/kids/thumbnails/2149740b.jpg")));
		...
		JLabel lblBrandawadox = new JLabel("Brand-B&G Kids");
		...
		label_2.setIcon(new ImageIcon(girl6.class.getResource("/Images/kids/thumbnails/2149740c.jpg")));
		...
		label.setIcon(new ImageIcon(girl6.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
	}
}
