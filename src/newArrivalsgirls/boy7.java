...
public class boy7 {
	...
	static public void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon(boy7.class.getResource("/Images/kids/coverpage/2235648a.jpg")));
		...
		JLabel lblRs = new JLabel("Rs 700");
		...
		JLabel lblNewLabel_1 = new JLabel("Mark & Mia Half Sleeves Romper With Tie - Grey ");
		lblNewLabel_1.setBounds(187, 434, 435, 20);
		frame.getContentPane().add(lblNewLabel_1);
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		
		JLabel label_3 = new JLabel("");
		label_3.setIcon(new ImageIcon(boy7.class.getResource("/Images/kids/thumbnails/boys/2235648b.jpg")));
		...
		JLabel lblBrandawadox = new JLabel("Brand-Mark & Mia");
		lblBrandawadox.setFont(new Font("Tahoma", Font.PLAIN, 11));
		panel_2.add(lblBrandawadox);
		
		JLabel lblTypeTee = new JLabel("Type : Romper with Tie");
		panel_2.add(lblTypeTee);
		
		JLabel lblNewLabel_7 = new JLabel("Neck -Collar Neck");
		...
		label_2.setIcon(new ImageIcon(boy7.class.getResource("/Images/kids/thumbnails/boys/2235648h.jpg")));
		...
		label.setIcon(new ImageIcon(boy7.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
	}
}
