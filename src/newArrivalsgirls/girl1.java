...
public class girl1 {
	...
	static public void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon(girl1.class.getResource("/Images/2084635a.jpg")));
		...
		JLabel lblNewLabel_1 = new JLabel("Huali Kids Bird Print Dress - White");
		lblNewLabel_1.setBounds(187, 434, 435, 20);
		frame.getContentPane().add(lblNewLabel_1);
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		
		JLabel label_3 = new JLabel("");
		label_3.setIcon(new ImageIcon(girl1.class.getResource("/Images/kids/thumbnails/2084635b.jpg")));
		...
		JLabel lblBrandawadox = new JLabel("Brand-Huali Kids");
		...
		label_2.setIcon(new ImageIcon(girl1.class.getResource("/Images/kids/thumbnails/2084635c.jpg")));
		...
		label.setIcon(new ImageIcon(girl1.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
	}
}
