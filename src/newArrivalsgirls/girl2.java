...
public class girl2 {
	...
	static public void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon(girl2.class.getResource("/Images/2090150a.jpg")));
		...
		JLabel lblRs = new JLabel("Rs 195");
		...
		JLabel lblNewLabel_1 = new JLabel("Kookie Kids Cats  Printd Tee-Purple");
		lblNewLabel_1.setBounds(187, 434, 435, 20);
		frame.getContentPane().add(lblNewLabel_1);
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		
		JLabel label_3 = new JLabel("");
		label_3.setIcon(new ImageIcon(girl2.class.getResource("/Images/kids/thumbnails/2090150b.jpg")));
		...
		JLabel lblBrandawadox = new JLabel("Brand-Kookie Kids");
		lblBrandawadox.setFont(new Font("Tahoma", Font.PLAIN, 11));
		panel_2.add(lblBrandawadox);
		
		JLabel lblTypeTee = new JLabel("Type : Tee");
		...
		label_2.setIcon(new ImageIcon(girl2.class.getResource("/Images/kids/thumbnails/2090150c.jpg")));
		...
		label.setIcon(new ImageIcon(girl2.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
	}
}
