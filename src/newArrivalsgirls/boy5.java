...
public class boy5 {
	...
	static public void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon(boy5.class.getResource("/Images/kids/coverpage/2107381a.jpg")));
		...
		JLabel lblRs = new JLabel("Rs 600");
		...
		JLabel lblNewLabel_1 = new JLabel("Babyhug Party Wear Check Shirt And Bow ");
		lblNewLabel_1.setBounds(187, 434, 435, 20);
		frame.getContentPane().add(lblNewLabel_1);
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		
		JLabel label_3 = new JLabel("");
		label_3.setIcon(new ImageIcon(boy5.class.getResource("/Images/kids/thumbnails/boys/2107381b.jpg")));
		...
		JLabel lblBrandawadox = new JLabel("Brand-Babyhug");
		lblBrandawadox.setFont(new Font("Tahoma", Font.PLAIN, 11));
		panel_2.add(lblBrandawadox);
		
		JLabel lblTypeTee = new JLabel("Type : Shirt");
		panel_2.add(lblTypeTee);
		
		JLabel lblNewLabel_7 = new JLabel("Neck -Collar ");
		...
		JLabel lblNewLabel_4 = new JLabel(" Occation- Party wear");
		...
		label_2.setIcon(new ImageIcon(boy5.class.getResource("/Images/kids/thumbnails/boys/2107381f.jpg")));
		...
		label.setIcon(new ImageIcon(boy5.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
	}
}
