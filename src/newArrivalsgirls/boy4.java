...
public class boy4 {
	...
	static public void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon(boy4.class.getResource("/Images/kids/coverpage/2244600a.jpg")));
		...
		JLabel lblNewLabel_1 = new JLabel("ToffyHouse Striped Tee & Trouser - White Pink ");
		lblNewLabel_1.setBounds(187, 434, 435, 20);
		frame.getContentPane().add(lblNewLabel_1);
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		
		JLabel label_3 = new JLabel("");
		label_3.setIcon(new ImageIcon(boy4.class.getResource("/Images/kids/thumbnails/boys/2244600b.jpg")));
		...
		JLabel lblBrandawadox = new JLabel("Brand-ToffyHouse ");
		lblBrandawadox.setFont(new Font("Tahoma", Font.PLAIN, 11));
		panel_2.add(lblBrandawadox);
		
		JLabel lblTypeTee = new JLabel("Type : Tee & Trouser");
		...
		label_2.setIcon(new ImageIcon(boy4.class.getResource("/Images/kids/thumbnails/boys/2244600d.jpg")));
		...
		label.setIcon(new ImageIcon(boy4.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
	}
}
