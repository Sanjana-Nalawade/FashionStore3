...
public class girl5 {
	...
	static public void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon(girl5.class.getResource("/Images/1974163a.jpg")));
		lblNewLabel.setBounds(187, 69, 365, 354);
		...
		JLabel lblNewLabel_1 = new JLabel("Little Kangaroos Pom Pom Solid Shorts - Aqua Blue");
		lblNewLabel_1.setBounds(187, 434, 435, 20);
		frame.getContentPane().add(lblNewLabel_1);
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		
		JLabel label_3 = new JLabel("");
		label_3.setIcon(new ImageIcon(girl5.class.getResource("/Images/kids/thumbnails/1974163b.jpg")));
		...
		JLabel lblBrandawadox = new JLabel("Brand-Little Kangaroos");
		lblBrandawadox.setFont(new Font("Tahoma", Font.PLAIN, 11));
		panel_2.add(lblBrandawadox);
		
		JLabel lblTypeTee = new JLabel("Type : Shorts");
		panel_2.add(lblTypeTee);
		
		JLabel lblNewLabel_7 = new JLabel("Length - Shorts ");
		...
		label_2.setIcon(new ImageIcon(girl5.class.getResource("/Images/kids/thumbnails/1974163c.jpg")));
		label_2.setBounds(561, 252, 139, 178);
		...
		label.setIcon(new ImageIcon(girl5.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
	}
}
