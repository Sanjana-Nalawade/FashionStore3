...
public class D8 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(D8.class.getResource("/Images/Women/Clothes/tops/15278398362876180144.jpg")));
		...
		label_3.setIcon(new ImageIcon(D8.class.getResource("/Images/Women/Clothes/tops/15278398342485656010.jpg")));
		...
		label_4.setIcon(new ImageIcon(D8.class.getResource("/Images/Women/Clothes/tops/15278398352082651554.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Knot Hem Crop Tee");
		...
		JLabel label_14 = new JLabel("\u20B9579.00");
		...
		button.setBounds(83, 430, 167, 29);
		panel_3.add(button);
		...
		label.setIcon(new ImageIcon(D8.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
