...
public class D3 extends D4 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(D3.class.getResource("/Images/Women/Clothes/tops/3_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(D3.class.getResource("/Images/Women/Clothes/tops/3_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(D3.class.getResource("/Images/Women/Clothes/tops/3_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Open Shoulder Tie Dye Crop Tee");
		...
		button.setBounds(81, 433, 167, 29);
		panel_3.add(button);
		...
		label.setIcon(new ImageIcon(D3.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
