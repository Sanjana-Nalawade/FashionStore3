...
public class D5 extends D6 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(D5.class.getResource("/Images/Women/Clothes/tops/5_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(D5.class.getResource("/Images/Women/Clothes/tops/5_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(D5.class.getResource("/Images/Women/Clothes/tops/5_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Frill Cut Out Knot Tee");
		...
		button.setBounds(84, 434, 167, 29);
		panel_3.add(button);
		...
		label.setIcon(new ImageIcon(D5.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
