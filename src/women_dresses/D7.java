...
public class D7 extends D8{
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(D7.class.getResource("/Images/Women/Clothes/tops/7_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(D7.class.getResource("/Images/Women/Clothes/tops/7_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(D7.class.getResource("/Images/Women/Clothes/tops/7_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Knee Length Dungree");
		...
		JLabel label_14 = new JLabel("\u20B9690.00");
		...
		button.setBounds(89, 437, 167, 29);
		panel_3.add(button);
		button.setFont(new Font("Tahoma", Font.PLAIN, 16));
		
		JLabel label = new JLabel("");
		label.setBounds(0, 0, 752, 595);
		label.setIcon(new ImageIcon(D7.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
