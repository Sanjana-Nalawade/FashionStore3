...
public class D2 extends D3 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(D2.class.getResource("/Images/Women/Clothes/tops/2_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(D2.class.getResource("/Images/Women/Clothes/tops/2_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(D2.class.getResource("/Images/Women/Clothes/tops/2_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Off Shoulder Ribbed Tee");
		...
		JLabel label_14 = new JLabel("\u20B9600.00");
		...
		label.setIcon(new ImageIcon(D2.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
