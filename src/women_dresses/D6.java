...
public class D6 extends D7 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(D6.class.getResource("/Images/Women/Clothes/tops/6_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(D6.class.getResource("/Images/Women/Clothes/tops/6_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(D6.class.getResource("/Images/Women/Clothes/tops/6_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Lace Panel Crop Tee");
		...
		JLabel label_14 = new JLabel("\u20B9455.00");
		...
		button.setBounds(87, 436, 167, 29);
		panel_3.add(button);
		...
		label.setIcon(new ImageIcon(D6.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
