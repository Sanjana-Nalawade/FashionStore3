...
public class Sh4 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(Sh4.class.getResource("/Images/Men/shoes/4_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(Sh4.class.getResource("/Images/Men/shoes/4_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(Sh4.class.getResource("/Images/Men/shoes/4_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Air Epic Speed Tr Ii Training Shoes");
		...
		label.setIcon(new ImageIcon(Sh4.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
