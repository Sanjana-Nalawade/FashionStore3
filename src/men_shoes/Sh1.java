...
public class Sh1 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(Sh1.class.getResource("/Images/Men/shoes/1_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(Sh1.class.getResource("/Images/Men/shoes/1_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(Sh1.class.getResource("/Images/Men/shoes/1_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Air Max Infuriate Low Basketball Shoes");
		...
		JLabel lbl1 = new JLabel("Rs. 2,798");
		lbl1.setFont(new Font("Tahoma", Font.BOLD, 16));
		lbl1.setBackground(Color.WHITE);
		lbl1.setBounds(220, 406, 91, 20);
		...
		label.setIcon(new ImageIcon(Sh1.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
