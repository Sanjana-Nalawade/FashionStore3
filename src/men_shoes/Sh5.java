...
public class Sh5 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(Sh5.class.getResource("/Images/Men/shoes/5_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(Sh5.class.getResource("/Images/Men/shoes/8_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(Sh5.class.getResource("/Images/Men/shoes/5_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Tanjun Racer Shoes");
		...
		label.setIcon(new ImageIcon(Sh5.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
