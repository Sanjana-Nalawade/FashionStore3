...
public class Sh3 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(Sh3.class.getResource("/Images/Men/shoes/3_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(Sh3.class.getResource("/Images/Men/shoes/3_2.jpg")));
		...
		lbl3.setIcon(new ImageIcon(Sh3.class.getResource("/Images/Men/shoes/3_3.jpg")));
		lbl3.setBackground(new Color(192, 192, 192));
		lbl3.setOpaque(true);
		lbl3.setBounds(532, 218, 145, 145);
		...
		JLabel lblKnotHemCrop = new JLabel("Air Zoom Pegasus 34 Running Shoes");
		...
		label.setIcon(new ImageIcon(Sh3.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
