...
public class Sh8 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(Sh8.class.getResource("/Images/Men/shoes/8_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(Sh8.class.getResource("/Images/Men/shoes/8_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(Sh8.class.getResource("/Images/Men/shoes/8_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Lunarglide 9 Running Shoes");
		...
		JLabel lbl8 = new JLabel("Rs. 4,398");
		...
		label.setIcon(new ImageIcon(Sh8.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
