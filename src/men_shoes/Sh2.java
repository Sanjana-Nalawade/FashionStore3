...
public class Sh2 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(Sh2.class.getResource("/Images/Men/shoes/2_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(Sh2.class.getResource("/Images/Men/shoes/2_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(Sh2.class.getResource("/Images/Men/shoes/2_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("CL \u201CAttentive Leather Pack\u201D Trainers");
		...
		JLabel lbl2 = new JLabel("Rs. 4,000");
		lbl2.setFont(new Font("Tahoma", Font.BOLD, 16));
		lbl2.setBackground(Color.WHITE);
		lbl2.setBounds(220, 406, 91, 20);
		...
		label.setIcon(new ImageIcon(Sh2.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
