...
public class Sh6 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(Sh6.class.getResource("/Images/Men/shoes/6_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(Sh6.class.getResource("/Images/Men/shoes/6_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(Sh6.class.getResource("/Images/Men/shoes/6_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Hi Top Sneakers");
		...
		label.setIcon(new ImageIcon(Sh6.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
