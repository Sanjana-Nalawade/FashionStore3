...
public class Sh7 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(Sh7.class.getResource("/Images/Men/shoes/7_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(Sh7.class.getResource("/Images/Men/shoes/7_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(Sh7.class.getResource("/Images/Men/shoes/7_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Casual Slip-Ons In Contrast Detailing");
		...
		label.setIcon(new ImageIcon(Sh7.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
