...
public class J7 extends J8{
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(J7.class.getResource("/Images/Women/Clothes/jeans/7_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(J7.class.getResource("/Images/Women/Clothes/jeans/7_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(J7.class.getResource("/Images/Women/Clothes/jeans/7_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Skinny Ankle Jeans");
		...
		JLabel label_14 = new JLabel("\u20B9883.00");
		...
		label.setIcon(new ImageIcon(J7.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
