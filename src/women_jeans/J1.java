...
public class J1 extends J2{
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(J1.class.getResource("/Images/Women/Clothes/jeans/1_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(J1.class.getResource("/Images/Women/Clothes/jeans/1_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(J1.class.getResource("/Images/Women/Clothes/jeans/1_3 (2).jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Ripped Skinny Jeans");
		...
		JLabel label_14 = new JLabel("\u20B91111.00");
		...
		button.setBounds(123, 442, 167, 29);
		panel_3.add(button);
		...
		label.setIcon(new ImageIcon(J1.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
