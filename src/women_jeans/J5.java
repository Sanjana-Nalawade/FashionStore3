...
public class J5 extends J6{
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(J5.class.getResource("/Images/Women/Clothes/jeans/5_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(J5.class.getResource("/Images/Women/Clothes/jeans/5_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(J5.class.getResource("/Images/Women/Clothes/jeans/5_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Roll Up Hem Ripped Jeans");
		...
		JLabel label_14 = new JLabel("\u20B91069.00");
		...
		label.setIcon(new ImageIcon(J5.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
