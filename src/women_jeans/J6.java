...
public class J6 extends J7{
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(J6.class.getResource("/Images/Women/Clothes/jeans/6_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(J6.class.getResource("/Images/Women/Clothes/jeans/6_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(J6.class.getResource("/Images/Women/Clothes/jeans/6_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Straight Ripped Crop Jeans");
		...
		JLabel label_14 = new JLabel("\u20B91118.00");
		...
		label.setIcon(new ImageIcon(J6.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
