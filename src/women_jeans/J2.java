...
public class J2 extends J3{
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(J2.class.getResource("/Images/Women/Clothes/jeans/2_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(J2.class.getResource("/Images/Women/Clothes/jeans/2_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(J2.class.getResource("/Images/Women/Clothes/jeans/2_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Tie Waist Striped Jeans            ");
		...
		label.setIcon(new ImageIcon(J2.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
