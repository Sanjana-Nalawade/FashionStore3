...
public class J6 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(J6.class.getResource("/Images/Men/jeans/6_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(J6.class.getResource("/Images/Men/jeans/6_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(J6.class.getResource("/Images/Men/jeans/6_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Men Pocket Detail Drawstring Waist Solid Pants");
