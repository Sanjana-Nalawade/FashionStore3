...
public class J4 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(J4.class.getResource("/Images/Men/jeans/4_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(J4.class.getResource("/Images/Men/jeans/4_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(J4.class.getResource("/Images/Men/jeans/4_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Men Letter Print Rolled Hem Harem Pants");
		...
		JLabel lbl4 = new JLabel("\u20B91490.00");
		...
		label.setIcon(new ImageIcon(J4.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
