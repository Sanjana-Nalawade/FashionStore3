...
public class J7 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(J7.class.getResource("/Images/Men/jeans/7_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(J7.class.getResource("/Images/Men/jeans/7_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(J7.class.getResource("/Images/Men/jeans/7_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Men Camo Print Drawstring Waist Pants");
		...
		JLabel lbl7 = new JLabel("\u20B91332.00");
