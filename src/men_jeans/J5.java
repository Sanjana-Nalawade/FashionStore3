...
public class J5 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(J5.class.getResource("/Images/Men/jeans/5_1.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Men Elastic Foot Drawstring Pants");
		...
		JLabel lbl5 = new JLabel("\u20B91000.00");
		...
		label_3.setBounds(345, 77, 145, 145);
		panel_3.add(label_3);
		label_3.setIcon(new ImageIcon(J5.class.getResource("/Images/Men/jeans/5_2.jpg")));
