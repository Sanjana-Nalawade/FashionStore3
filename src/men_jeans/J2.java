...
public class J2 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(J2.class.getResource("/Images/Men/jeans/2_1.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Men Camo Elastic Foot Close Skinny Pants");
		...
		JLabel lbl2 = new JLabel("\u20B91401.00");
