...
public class J1 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(J1.class.getResource("/Images/Men/jeans/1_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(J1.class.getResource("/Images/Men/jeans/1_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(J1.class.getResource("/Images/Men/jeans/1_3.jpg")));
		...
		JLabel lbl1 = new JLabel("Men Letter Print Drawstring Pocket Pants");
		lbl1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lbl1.setBounds(220, 378, 435, 20);
		frame.getContentPane().add(lbl1);
		
		JLabel label_14 = new JLabel("\u20B91131.00");
