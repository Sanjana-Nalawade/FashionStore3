...
public class J8 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(J8.class.getResource("/Images/Men/jeans/8_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(J8.class.getResource("/Images/Men/jeans/8_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(J8.class.getResource("/Images/Men/jeans/8_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Men Pocket Detail Camo Print Pants");
		...
		JLabel lbl8 = new JLabel("\u20B91394.00");
		lbl8.setFont(new Font("Tahoma", Font.BOLD, 16));
		lbl8.setBackground(Color.WHITE);
		lbl8.setBounds(220, 406, 91, 20);
		...
		label.setIcon(new ImageIcon(J8.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
