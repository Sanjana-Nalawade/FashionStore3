...
public class S6 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(S6.class.getResource("/Images/Men/shirt/6_1.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Men Letter And Tropical Print Tee");
		...
		label_3.setBounds(341, 97, 145, 145);
		panel_3.add(label_3);
		label_3.setIcon(new ImageIcon(S6.class.getResource("/Images/Men/shirt/6_2.jpg")));
