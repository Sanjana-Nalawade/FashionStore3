...
public class S3 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(S3.class.getResource("/Images/Men/shirt/3_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(S3.class.getResource("/Images/Men/shirt/3_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(S3.class.getResource("/Images/Men/shirt/3_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Men Branches Print Blouse");
