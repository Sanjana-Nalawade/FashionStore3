...
public class S2 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(S2.class.getResource("/Images/Men/shirt/2_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(S2.class.getResource("/Images/Men/shirt/2_3.jpg")));
		...
		label_4.setIcon(new ImageIcon(S2.class.getResource("/Images/Men/shirt/2_2.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Men Space Dye Tee");
