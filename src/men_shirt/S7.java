...
public class S7 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(S7.class.getResource("/Images/Men/shirt/7_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(S7.class.getResource("/Images/Men/shirt/7_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(S7.class.getResource("/Images/Men/shirt/7_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Men Galaxy Print Tee");
