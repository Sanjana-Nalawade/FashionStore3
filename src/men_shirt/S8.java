...
public class S8 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(S8.class.getResource("/Images/Men/shirt/8_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(S8.class.getResource("/Images/Men/shirt/8_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(S8.class.getResource("/Images/Men/shirt/8_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Men Forest Print Tee");
		...
		label.setIcon(new ImageIcon(S8.class.getResource("/Images/Linen-Solid-Color-Background-Wallpaper-5120x2880.png")));
