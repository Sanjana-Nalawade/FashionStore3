...
public class S4 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(S4.class.getResource("/Images/Men/shirt/4_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(S4.class.getResource("/Images/Men/shirt/4_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(S4.class.getResource("/Images/Men/shirt/4_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Men Striped Blouse");
