...
public class S1 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(S1.class.getResource("/Images/Men/shirt/1_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(S1.class.getResource("/Images/Men/shirt/1_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(S1.class.getResource("/Images/Men/shirt/1_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Men Grid Print Blouse");
