...
public class S5 {
	...
	static public void initialize() {
		...
		label_2.setIcon(new ImageIcon(S5.class.getResource("/Images/Men/shirt/5_1.jpg")));
		...
		label_3.setIcon(new ImageIcon(S5.class.getResource("/Images/Men/shirt/5_2.jpg")));
		...
		label_4.setIcon(new ImageIcon(S5.class.getResource("/Images/Men/shirt/5_3.jpg")));
		...
		JLabel lblKnotHemCrop = new JLabel("Men Feather Print Shirt");
